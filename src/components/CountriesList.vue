...
export default {
  ...
  methods: {
    async fetchCountries() {
      ...
      //Hacer que el fetch se represente alfabeticamente. Sort
      this.countries = finalResponse.sort((a, b) => {
        //localCompare() para pintar datos ordenadamente.
        return a.name.common.localeCompare(b.name.common);
      });
    },
  },

  // USamos el created-hook [created()] y dependemos de él para hacer nuestra llamada inciial a la base de datos
  // y nos traemos esa info antes de que se pinte algo en el UI.
  created() {
    this.fetchCountries();
  },
};
